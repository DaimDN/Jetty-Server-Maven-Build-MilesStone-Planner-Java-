        ...
        <div class="container login-container">
            <div class="row">
                ...
                <div class="col-md-6 login-form-2">
                    <h3>Select a menu to delete Milestones.</h3>
                    <br>
                    <table>
                        <tbody>
                        <tr>
                            ...
                            <td width="10%">
                                ...
                                <button class="btn btn-danger" onclick="window.location.href='/views/DeleteMilestone.jsp'">Delete
                                <%
