...
<html>
<head>
    <title>Register - Milestone Planner</title>
    ...
    <div class="container login-container">
        <div class="row">
            <div class="col-md-6 login-form-1">
                ...
                <br>
                <img src="./Resources/reg.png" width="500px">
            ...
            <div class="col-md-6 login-form-2">
                ...
                <form action="../controller/registerProcess.jsp" method="GET" name="registerForm">
                    ...
                    <div class="form-group">
                        <input  style="width: 200px;" class="btn btn-primary" value="Register"  type="submit" name="Register" /> &nbsp;
                        <a  style="width: 200px;" class="btn btn-danger" href="login.jsp">Login</a>
